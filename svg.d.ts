export class SVG {
	...
	static Text(x: number, y: number, content: string, properties?: {[key: string]: string | number | boolean}): SVGTextElement;
	...
	static TextWrap(text: SVGTextElement, width: number): void;
	static TextEllipsis(text: SVGTextElement, width: number): void;
	static Center(element: SVGElement, x1: number, x2: number, y1: number, y2: number): void;
}
